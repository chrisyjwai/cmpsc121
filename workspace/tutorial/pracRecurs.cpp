...
double intPower( double base, int exponent)
{
    if (exponent == 0) {
        ...
        return intPower(base,exponent + 1) / base;
    }
    else {
        return intPower(base,exponent - 1) * base;
    }
...
//
// DO NOT Call the function listed about for STEP 5 -- that uses recursion!
...
//            (Depends on how much money you have to insert afterwards)
//        How many ways can I get my result if I first insert a quarter?
//        If the first coin I insert must be either a dime or a quarter,
//            how many total ways can I get my result?
